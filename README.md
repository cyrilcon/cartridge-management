...
- `Статус: str` — текущее состояние ячейки (Состояния: `исправен` — в ячейке лежит **исправный** картридж,
  `неисправен` — в ячейке лежит **неисправный** картридж).
...
![Замена картриджа сотрудником](diagrams/sequence-diagram-1.png)

---

### Обработка отсутствия картриджей

![Обработка отсутствия картриджей](diagrams/sequence-diagram-2.png)

---

### Пополнение картриджей администратором

![Пополнение картриджей администратором](diagrams/sequence-diagram-3.png)
